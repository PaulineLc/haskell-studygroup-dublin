...
/* package haskell-studygroup-0.1.0.0 */
#define VERSION_haskell_studygroup "0.1.0.0"
#define MIN_VERSION_haskell_studygroup(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-studygroup-0.1.0.0-L0sS7a7cKTVEJjqRRCA6uK"

#define CURRENT_PACKAGE_KEY "haskell-studygroup-0.1.0.0-L0sS7a7cKTVEJjqRRCA6uK"
